...
here is the full map of the current victorian train network:
...
here is a map of the suburban rail loop:
...
# conclusion
this concludes our brief venture into victoria's (although mostly melbourne's) convoluted metro system.